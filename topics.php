...
if (strpos($path, 'topics/') !== false) {
    $technologyNItemstr = substr($path, strpos($path, "topics/") + 7);
    ...
    if (strpos($technologyNItemstr, '/') !== false) {
        ...
        $title = $_SESSION['webTitle']. " | ReaderNook";
    ...
    for ($i = 0; $i < count($rows); $i++) {
        if ($rows[$i]['itemid'] == $itemid) {
            if (isset($rows[$i + 1])) {
                ...
                $nextTutorialTitleURL = $myUrl . "topics/" . $nextTechnology . "/" . $itemName;
...
function getTutorialsListHTML($database, $technologyFilter, $tutTitle)
{
    ...
    for ($i = 0; $i < count($rows); $i++) {
        ...
        $tutorialTitleURL = $myUrl . "topics/" . strtolower($technology) . "/" . strtolower($itemName);
    ...
    <div id="page-content-wrapper">
       ...
       <div id="containerNHelpDivId" >
          ...
          <div id="mainContainer" style="min-height: 700px; width: 100%;" class="panel-container panel-left">
                ...
                <?php if ($tutTitle == ""): ?>
                    <div id="tutorialListDivId" style="width: 100%">
                    ...
                    <div id="tutorialDivId" style="display: none">

                    </div>

                    <div id="tutorialEditDivId" style="display: none">
                    </div>
