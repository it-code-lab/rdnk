...
<head>
   ...
   <link rel="stylesheet" href="/readernook/web/common-style.css">
   ...
   <script src="/readernook/js/jquery-resizable-delit.js"></script>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/4.9.2/tinymce.min.js" referrerpolicy="origin"></script>
      ...
      <link rel="stylesheet" href="/readernook/css/default.min.css">
      <script src="/readernook/js/highlight.min.js"></script>
   ...
   <!--
         ...
         -->
   <script src="/readernook/js/lib/unpackers/javascriptobfuscator_unpacker.js"></script>
   <script src="/readernook/js/lib/unpackers/urlencode_unpacker.js"></script>
   <script src="/readernook/js/lib/unpackers/p_a_c_k_e_r_unpacker.js"></script>
   ...
   <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
         ...
         <div class="topnav" id="myTopnav">
            <a id="homeLinkId" href="/readernook/?target=home">HOME</a>

            <a id="tutorialLinkId" href="/readernook/?target=tutorial">TOPICS <i  class="fa fa-caret-down"></i></a> 
            ...
            <!-- <a id="projectscannerLinkId" href="/readernook/?target=projectscanner">PROJECT SCANNER</a>
            <a id="filescannerLinkId" href="/readernook/?target=filescanner">FILE SCANNER</a>
            <a id="HelpTopicsLinkId" style="display:none" href="/readernook/?target=HelpTopics">HELP TOPICS</a>
            <a id="howtoLinkId" href="/readernook/?target=howto">HOW TO VIDEOS</a> -->
            <a id="contactusLinkId" href="/readernook/?target=contactus">CONTACT US</a>
            <a id="loginLinkId" href="/readernook/?target=login">LOG IN</a>
            <a id="logoutLinkId" style="display:none" href="javascript:Logout()">LOGOUT</a>
            <a id="profileLinkId" style="display:none" href="/readernook/?target=profile"">PROFILE</a>
                  ...
                  <div class="bannerParent">
                     ...
                     <div id="homeCardsContainerDivId">
                        <div class="menucard" onclick="Show('tutorial')"">
                           ...
                           <hr>
                           <div class="cardMsg">Tutorials and Easy Lessons</div>
                           <!-- <p><button onclick="Show('tutorial')">Go</button></p> -->
                        </div>
<!--                         <div class="menucard" onclick="Show('projectscanner')">
                           <img src="/readernook/images/prjscan.png" alt="Project Scan" class="homeCardImg">
                        ...
                        <div class="menucard" onclick="Show('filescanner')">
                           <img src="/readernook/images/filescan.png" alt="File Scan" class="homeCardImg">
   ...
   <footer>
      <div class="footer-main">
        <div class="footer-col1">
          <ul>
            <li>
               <img src="/readernook/assets/favicon-1.png" alt="IT Code Scanner" class="languageicon">
            </li>
        ...
        <div class="footer-col2">
          ...
          <div class="footer-languages">
            <a href="/readernook/?target=home">Home</a>
            <a href="/readernook/?target=tutorial">TOPICS</a>
            <a href="/readernook/?target=contactus">Contact Us</a>
          </div>
        </div>
      ...
      <p class="footer-terms">
        <a href="#">© 2022 Reader Nook. All rights reserved</a>
   ...
   <!-- Core theme JS-->
   <script src="/readernook/js/scripts.js"></script>
   <!--
         <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
   ...
   <script src="/readernook/web/onload.js"></script>
